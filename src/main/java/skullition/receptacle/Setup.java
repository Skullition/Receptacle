...
import skullition.receptacle.items.PortableShelterItem;

public class Setup {
    // items
    public static final PortableShelterItem PORTABLE_SHELTER_ITEM = new PortableShelterItem(new FabricItemSettings().group(Receptacle.RECEPTACLE_ITEM_GROUP).maxCount(16));
    // blocks
    ...
    public static void registerAll() {
        // items
        Registry.register(Registry.ITEM, new Identifier(Receptacle.MODID, "portable_shelter_item"), PORTABLE_SHELTER_ITEM);
        // blocks
