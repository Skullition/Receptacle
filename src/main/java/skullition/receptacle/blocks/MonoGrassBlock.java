...
import skullition.receptacle.blocks.abstractblocks.SpreadableMonoBlock;

import java.util.List;
import java.util.Random;

public class MonoGrassBlock extends SpreadableMonoBlock implements Fertilizable {
    public MonoGrassBlock(Settings settings) {
        super(settings);
    }
