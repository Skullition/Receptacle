package skullition.receptacle.render.entity.model;
...
public class RideableDolphinEntityModel<T extends Entity> extends SinglePartEntityModel<T> {
    private final ModelPart root;
    private final ModelPart body;
    private final ModelPart tail;
    private final ModelPart tailFin;

    public RideableDolphinEntityModel(ModelPart root) {
        this.root = root;
